 ...
 * Offered alongside EquipmentBarcode.tsx (CODE128) rather than replacing
 * it: a QR scans well from a phone at normal distance, a barcode scans
 * better printed small/at an angle on a cable — let whoever prints the
 * label pick.
 */
